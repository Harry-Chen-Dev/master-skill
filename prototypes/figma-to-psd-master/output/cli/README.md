# Figma 转 Photoshop (PSD) CLI

把 Figma 转 Photoshop (PSD) master skill 的认知 OS 物化成 bash 工具。
...
| `decision/figma.sh` | Figma 决策树 (3 条规则) |
| `decision/evidence.sh` | Evidence 决策树 (1 条规则) |
| `decision/psd.sh` | Psd 决策树 (3 条规则) |
| `decision/topic-4.sh` | 字体 决策树 (1 条规则) |
| `decision/blur.sh` | Blur 决策树 (2 条规则) |
