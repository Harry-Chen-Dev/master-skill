...
基于 1 条规则:
  • 如果 涉及 DMCA takedown → 则 : 区分 DMCA 和账号封禁 — DMCA 有独立的 counter-notice 流程 (17 U.S.C
...
declare -a RULE_ACTIONS=(
  ": 区分 DMCA 和账号封禁 — DMCA 有独立的 counter-notice 流程 (17 U.S.C"
)
