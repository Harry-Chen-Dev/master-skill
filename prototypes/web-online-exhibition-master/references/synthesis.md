# Web 线上展览 / 虚拟展厅开发 · Master OS (Phase 2 Synthesis)

> 行业本质：用 web 技术把"展览"搬上浏览器——在性能、沉浸、工期、成本的多重约束下，搭出能在移动端流畅跑、有策展动线、能达成业务目标的线上展。
> 一句话定性：**线上展览开发不是"把 3D 模型丢上网"，是「资产管线性能工程 + 策展动线设计 + 业务转化」三合一；第一性难题是 web 3D 的性能——大模型不压缩、移动端不降级，再美的展也打不开。**
> 研究日期：2026-06-06。一手率 ≈ 73.7%（canon 全球：Khronos glTF / W3C WebGPU·WebXR / Three.js / IIIF）。0 黑名单。
