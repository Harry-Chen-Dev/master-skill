...
explain() {
  cat <<'EOT'
这个决策助手把 玩法 主题下的 playbook 规则组合成交互树。

基于 2 条规则:
  • 如果 你有了一个游戏点子, 准备开做 → 则 : 则 先做最便宜的原型 (纸面/灰盒) 验证「核心玩法好不好玩 (find the fun)」, 再投美术/内容; f
  • 如果 玩法与叙事打架 (ludonarrative dissonance) → 则 : 则 让叙事服务玩法或玩法服务叙事、选一个主导, 别让「剧情里他是和平主义者、玩法里他屠杀千人」式割裂破坏沉浸; 优先
...
declare -a RULE_CONDITIONS=(
  "你有了一个游戏点子, 准备开做"
  "玩法与叙事打架 (ludonarrative dissonance)"
)
declare -a RULE_ACTIONS=(
  ": 则 先做最便宜的原型 (纸面/灰盒) 验证「核心玩法好不好玩 (find the fun)」, 再投美术/内容; fun 没找到前别进生产, 别在错误地基上盖楼"
  ": 则 让叙事服务玩法或玩法服务叙事、选一个主导, 别让「剧情里他是和平主义者、玩法里他屠杀千人」式割裂破坏沉浸; 优先环境/系统叙事让故事从玩法里长出来"
)
