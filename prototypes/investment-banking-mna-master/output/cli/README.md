...
把 投行并购 master skill 的认知 OS 物化成 bash 工具。
...
| `decision/topic-1.sh` | —— 决策树 (1 条规则) |
| `decision/topic-2.sh` | 成交 决策树 (1 条规则) |
| `decision/synergy.sh` | Synergy 决策树 (2 条规则) |
| `decision/topic-4.sh` | 价格 决策树 (1 条规则) |
