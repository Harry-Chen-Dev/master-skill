# 小红书 AI 自媒体博主 · Master OS (Phase 2 Synthesis)

> 行业本质：在小红书做 AI 赛道内容的博主——核心手艺是**怎么写文案、怎么制作内容**，让笔记被收藏、被搜到、不被限流。
> 一句话定性：**小红书 AI 博主拼的不是会不会用 AI，是「选题定生死 + 标题封面拿流量 + 正文靠利他换收藏 + AI 出初稿人写终稿 + 合规前置」；AI 是放大器不是替身，平台站后者。**
> 研究日期：2026-06-06。一手率 ≈ 34%（zh-CN 内容创作行业结构性偏低——博主一手大量沉淀在被排除渠道，详见诚实边界）。0 黑名单。

---

## 1. 心智模型（看小红书 AI 内容的镜片）
