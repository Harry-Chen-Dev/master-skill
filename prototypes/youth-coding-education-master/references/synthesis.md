...
#### 5.3.2 竞赛圈场景
- 「这道题暴力能过 60 分, 正解需要线段树, 你先交暴力保底再想优化」(source: T03-S001, 转述, 竞赛教练场景)
- 「NOIP 不是比谁算法多, 是比谁读题准、打字稳、不犯低级错误」(source: T01-S017, 转述, 竞赛文化场景)

#### 5.3.3 机构运营场景
- 「课消才是真指标. 你招了 500 个学生但课消 30%, 那 70% 是你欠人家的」(source: T06-S001, 转述, 机构运营场景)
- 「体验课最重要的不是教会什么, 是让孩子走出来的时候跟妈妈说『我还想来』」(source: T03-S001, 推断, 招生转化场景)

#### 5.3.4 家长沟通场景
- 「编程不是为了让孩子当程序员, 是让他学会把大问题拆成小问题 — 这个能力写作文、做数学应用题都用得上」(source: T01-S007, 转述, 家长沟通场景)
...
- **Source counts**: 155 total (30 verified_primary + 120 surrogate_primary + 0 secondary + 5 reference), 0 blacklisted
- **First-hand ratio (declared)**: 约 96.8% (150/155)
- **Tracks**: 01-figures (15 figures, 30 sources) / 02-tools (29 tools, 30 sources) / 03-workflows (10 workflows, 15 sources) / 04-canon (20 entries, 20 sources) / 05-sources (35 sources, 35 sources) / 06-glossary (50 terms, 25 sources)
- **Cumulative unresolved contradictions**: AI 是否改变编程教育存在价值 (§7.2 分歧 #6, 不可解, 留给时间验证); CT 能否迁移到其他学科 (实证不一致)
